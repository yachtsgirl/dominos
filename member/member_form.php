...
?>
	...
	<div id="col2">
		...
		<div id="form_join">
			...
			<li>
			    <div id="id1">
			     ...
			     <div id="id2"><a href="#" id="ajax_request"><img src="../img/check_id.gif"></a></div>
		...
		<div id="button"><a href="#"><img src="../img/button_save.gif"  onclick="javascript:document.member_form.submit();()">                  </a>&nbsp;&nbsp;
